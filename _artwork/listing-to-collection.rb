...
apiKey = 'qe7sr94obrf8suy1060a20po'
shopID = '12853550'
rateLimit = '100'
stopChar = '|'

listing_url = "https://openapi.etsy.com/v2/shops/#{shopID}/listings/active?method=GET&api_key=#{apiKey}&limit=#{rateLimit}&offset=100"
